...
//  }
//   const onErr=(error)=>{
//     console.log("connectd websocket err",error);
//   }

//   useEffect(()=>{
//     if(stompClient && auth.user && currentChat){
//       const subcription = stompClient.subscribe(`/user/${currentChat.id}/private`,onMessageReice)
//     }
//   })
...
//   console.log("message revice form websocket ",newMessage);
// }
//   return (
//     <div>
...
//               </div>
//             </div>
//             <div className='hidenScrollbar overflow-y-scroll h-[75vh] px-2 space-y-5 py-5'>
